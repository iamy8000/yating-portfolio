...
export const translations = {
  en: {
    ...
    experience: {
      ...
      items: [
        { period: 'Jan 2026 – Present', title: 'Founding Engineer', company: 'ConnNext', description: 'Led frontend development for a React Native app at an early-stage startup, building a scalable UI system, auth/onboarding flows, and real-time networking features from pre-release to production.', tags: ['React Native', 'Expo', 'TypeScript', 'Clerk', 'JavaScript'] },
        { period: 'Aug 2024 – Jul 2025', title: 'Frontend Engineer', company: 'Tymeline', description: 'Built core UI components and data-driven dashboards for an AI-powered performance platform, improving development efficiency and enabling large-scale data visualization.', tags: ['React', 'JavaScript', 'Redux', 'TypeScript', 'Playwright', 'AWS'] },
  ...
  'zh-TW': {
    ...
    experience: {
      ...
      items: [
        { period: '2026年1月 – 至今', title: '創始工程師', company: 'ConnNext', description: '於早期新創主導 React Native app 的前端開發，建置可擴充的 UI 系統、登入／onboarding 流程與即時連線功能，從預發布到正式上線。', tags: ['React Native', 'Expo', 'TypeScript', 'Clerk', 'JavaScript'] },
