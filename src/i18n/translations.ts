...
export const translations = {
  en: {
    ...
    hero: {
      rotator: [
        ...
        'has 20+ of them.',
        'Ten are from Trader Joe\'s.',
        'always has a kindle in her bag.',
        'owns too many mugs.',
    ...
    me: {
      ...
      p2: "Outside of code I run. Central Park is the place that makes the city feel less overwhelming. I also keep a café list and a lot of small goals; to me the world is one big bucket list. There's so much to do, eat, see, and try. I like having things to look forward to!",
  ...
  'zh-TW': {
    ...
    about: {
      ...
      projects: '專案',
      learnMore: '更多關於我 :)',
      p1: '我畢業於美國馬里蘭大學資訊管理碩士，目前是一位擁有 4 年以上經驗的前端工程師。主要使用 React、Next.js、JavaScript、TypeScript、Redux 與 Material UI 開發產品，重視視覺細節與系統的可擴充性。我曾打造 AI 驅動的數據儀表板、WebRTC 視訊平台、Web3 應用，以及實際被大量使用者採用的行銷工具。',
      p2: '在轉職成工程師之前，我取得廣告學學士學位，並於 Ogilvy 工作兩年，參與 Nike 與 Google Play 的品牌專案。與設計師、策略規劃與工程師密切合作的過程，讓我學會從「體驗」的角度思考產品，而不只是功能本身。',
    ...
    me: {
      label: '關於我',
      p1: '我在台灣長大，研究所與工作期間搬到 DC 和馬里蘭，現在落腳紐約。還在適應、還在學習、也還在持續打造新的東西。在成為工程師之前，我在 Ogilvy 做廣告，與設計師、策略規劃和工程師一起參與 Nike 和 Google Play 的品牌專案。那段經驗讓我學會把產品視為一種「體驗」，而不只是功能的集合。',
      p2: '寫程式之外，我喜歡跑步。中央公園是讓這座城市沒那麼 overwhelming 的地方。我也很多清單，也有很多小目標；對我來說，世界就像一個很大的 bucket list。有太多事情值得去做、去吃、去看、去嘗試。我喜歡讓生活裡總是有一些期待。',
      p3: '我把這些都帶進前端開發裡：好奇心，以及在意。我很在乎清晰度，也在乎那些看似微小的細節如何影響使用者的感受。對我而言，好的前端不只是讓產品能運作，而是讓它自然、直覺、有方向 ✨',
    },
    experience: {
      label: '工作經驗',
      education: '學歷',
      ...
      items: [
        ...
        { period: '2017年12月 – 2019年6月', title: '業務經理', company: '奧美', description: '執行 Nike、Google Play 等全球品牌之品牌、數位與社群 campaign，與客戶、創作者、工程跨域協作。', tags: ['Campaign Execution', 'Cross-team Delivery', 'Brand Strategy', 'Project Management'] },
      ],
      educationItems: [
