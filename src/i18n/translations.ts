...
export const translations = {
  en: {
    ...
    experience: {
      ...
      items: [
        { period: 'Jan 2026 – Present', title: 'Founding Engineer', company: 'ConnNext', description: 'Lead frontend for the ConnNext mobile app (React Native / Expo) in a 4-engineer startup — scalable UI system, auth/onboarding, and real-time flows from early-stage to production.', tags: ['React Native', 'Expo', 'TypeScript', 'Clerk', 'JavaScript'] },
  ...
  'zh-TW': {
    ...
    experience: {
      ...
      items: [
        { period: '2026年1月 – 至今', title: '創始工程師', company: 'ConnNext', description: '在 4 人新創團隊中主導 ConnNext 行動 app（React Native / Expo）前端，從早期到上線：可擴充 UI 系統、登入/onboarding 與即時連線流程。', tags: ['React Native', 'Expo', 'TypeScript', 'Clerk', 'JavaScript'] },
